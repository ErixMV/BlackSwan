            ...
            <main className="rec">
                <div className="rec-l" style={{height: checked ? "fit-content": "auto"}}>
                    ...
                    <form className={classes.root} noValidate autoComplete="off">
                        ...
                        <div className="input-container">
                            {/* <label htmlFor="">Book #2</label> */}
                            <Autocomplete
                                id="combo-box-demo"
                                options={top100Films}
                                getOptionLabel={(option) => option.title}
                                style={{ width: 300, padding: "12px 0px" }}
                                renderInput={(params) => <TextField {...params} label="Book #2" variant="outlined" />}
                            />
                        </div>
                        <div className="input-container">
                            {/* <label htmlFor="">Book #3</label> */}
                            <Autocomplete
                                style={{ width: 300, padding: "12px 0px" }}
                                id="combo-box-demo"
                                options={top100Films}
                                getOptionLabel={(option) => option.title}
                                renderInput={(params) => <TextField {...params} label="Book #3" variant="outlined" />}
                            />
                        </div>
                    </form>
